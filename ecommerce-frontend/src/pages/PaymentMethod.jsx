  ...
  return (
    <div className="max-w-2xl mx-auto py-12">
      <div className="mb-8 flex items-center justify-between relative">
        ...
        <div className="absolute left-0 top-1/2 w-2/3 h-0.5 bg-gold-500 -z-10"></div>
      ...
      <div className="bg-dark-900 p-8 rounded-2xl border border-dark-700 shadow-sm">
        <h1 className="text-3xl font-black text-white mb-6">Payment Method</h1>
        
        <form onSubmit={submitHandler}>
          <div className="space-y-4 mb-8">
            <label className="flex items-center justify-between p-4 border border-dark-700 rounded-xl cursor-pointer hover:border-gold-500 transition has-[:checked]:border-gold-500 has-[:checked]:ring-1 has-[:checked]:ring-gold-500">
              <div className="flex items-center gap-3">
                ...
                />
                <span className="font-bold text-white">Credit Card (Stripe)</span>
              </div>
              <div className="flex gap-2">
                <span className="bg-dark-700 px-2 py-1 rounded text-xs font-bold text-gray-400">VISA</span>
                <span className="bg-dark-700 px-2 py-1 rounded text-xs font-bold text-gray-400">MC</span>
              </div>
            </label>
          ...
          <button 
            type="submit" 
            className="w-full bg-black text-white py-4 rounded-lg hover:bg-gold-500 transition font-bold tracking-wide"
          >
            Review Order
          </button>
        </form>
